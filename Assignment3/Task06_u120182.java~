...
public class Task06 {
	...
	public static void main(String args[]) {
		...
		model.getOntClass(ns + "Person").addSubClass(model.getOntClass(ns + "Researcher"));
		...
		Individual janeSmith = model.getOntClass(ns + "Researcher").createIndividual(ns + "JaneSmith");
