...
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		model.getOntClass("Person").addSubClass(researcher);
		
		// ** TASK 6.3: Create a new property named "worksIn" **
		Property worksIn = model.createProperty("worksIn");
		
		// ** TASK 6.4: Create a new individual of Researcher named "Jane Smith" **
		Individual janeSmith = model.createIndividual("Jane Smith", researcher);
		...
		Individual upm = model.createIndividual("Upm",university);
		model.getIndividual("John Smith").addProperty(worksIn, upm);
