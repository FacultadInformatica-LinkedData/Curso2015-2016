 ...
 * @author David Márquez Delgado u120350
 *
 */
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		person.addSuperClass(researcher);
		
		// ** TASK 6.3: Create a new property named "worksIn" **
		Property trabajaEn = model.createProperty(ns+"worksIN");
		...
		model.getIndividual(ns + "JohnSmith").addProperty(trabajaEn, UPM);
