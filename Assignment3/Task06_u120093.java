...
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		Individual universidad = model.createIndividual(ns+"UPM", university);
		model.getIndividual(ns+"JohnSmith").addProperty(worksIn, universidad);
